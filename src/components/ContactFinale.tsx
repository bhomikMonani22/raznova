...
/** Fully server rendered — reveals and the magnetic CTA pull both come
 * from the shared boot script in the root layout. */
      ...
      <div className="relative mx-auto flex max-w-4xl flex-col items-center px-5 py-24 text-center md:py-32">
        ...
        >
          <a
              ...
              className="magnetic cta-glow inline-flex min-h-14 items-center gap-3 rounded-[var(--radius-md)] bg-[var(--accent)] px-9 py-4 text-lg font-semibold text-[var(--accent-ink)]"
            >
            ...
            <a
              ...
              className="magnetic inline-flex min-h-14 items-center rounded-[var(--radius-md)] border border-[var(--line-strong)] px-9 py-4 text-lg font-semibold text-[var(--ink)] transition-colors hover:border-[var(--ink)]/40"
            >
